...
---
Data from "Secondary metabolites in a neotropical shrub: spatiotemporal allocation and role in fruit defense and dispersal" by L.D. Maynard, H.L. Slinn, A.E. Glassmire, B. Matarrita-Carranza, C.D. Dodson, T.T. Nguyen, M.J. Burroughs, L.A. Dyer, C.S. Jeffrey, S.R. Whitehead
Published in Ecology on (date)
Article DOI TBD

[![DOI](https://zenodo.org/badge/241215455.svg)](https://zenodo.org/badge/latestdoi/241215455)
...
The final extract was resuspended in DCM and analyzed using GCMS.

no = individual identifier
sample = sample number
tissue = tissue type (L=leaf, P=pulp/flower, S=seed)
plant = individual plant number (1-21)
stage = stage of tissue (1=ripe pulp, 2=unripe pulp, 3=unripe pulp, 4=flower, 5=flower, 6=developing flower, M=mature leaf)
...
Conc = concentration of alkenylphenols in the well
